...
def get_deepseek_analysis(symbol: str, start_date, end_date) -> str:
    ...
    user_prompt = (
        ...
        "Focus on specific developments such as new products, services, innovations, or notable trends directly tied to this company (e.g., product launches like Apple Vision Pro, new processors, or updates to flagship products). "
